      ...
      <div className="container mx-auto px-4">
        ...
        once: true
          ...
          <h2 className="font-display text-4xl md:text-5xl mb-4">
            WHY <span className="text-gradient">KEDIAMAN</span>?
          </h2>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">Everything you need to achieve your event goals is in one place</p>
        </motion.div>

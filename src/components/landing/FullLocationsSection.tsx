    ...
    <div className="bg-card rounded-xl sm:rounded-2xl border border-border overflow-hidden">
      ...
      <div className="relative aspect-[16/9] sm:aspect-[21/9] overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 md:p-8">
          ...
          <h3 className="font-serif text-xl sm:text-2xl md:text-4xl lg:text-5xl text-foreground leading-tight font-bold">
            {location.name}
          </h3>
        </div>
      </div>
      ...
      <div className="p-4 sm:p-6 md:p-8 space-y-4 sm:space-y-6">
        ...
        {(location.loading_area_description || location.loading_area_images?.length) && (
          <div className="border-t border-border pt-3 sm:pt-4">
            ...
            >
              <span className="font-serif text-lg sm:text-xl font-semibold">Loading Area</span>
        ...
        {(location.ballroom_layout_description || location.ballroom_layout_images?.length) && (
          <div className="border-t border-border pt-3 sm:pt-4">
            <button
              ...
              className="flex items-center justify-between w-full py-2 text-left hover:text-primary transition-colors"
            >
              <span className="font-serif text-lg sm:text-xl font-semibold">Ballroom Layout</span>
        ...
        {upcomingSchedules.length > 0 && (
          <div className="border-t border-border pt-3 sm:pt-4">
            <button
              ...
              className="flex items-center justify-between w-full py-2 text-left hover:text-primary transition-colors"
            >
              <span className="font-serif text-lg sm:text-xl font-semibold">Jadwal Ketersediaan</span>
        ...
        {portfolios.length > 0 && (
          <div className="border-t border-border pt-3 sm:pt-4">
            <button
              ...
              className="flex items-center justify-between w-full py-2 text-left hover:text-primary transition-colors"
            >
              <span className="font-serif text-lg sm:text-xl font-semibold">Event Portfolio</span>

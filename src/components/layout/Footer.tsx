        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            <Link to="/" className="flex items-center gap-2">
              ...
              <span className="font-serif text-2xl tracking-wider font-bold">{settings?.site_name || "KEDIAMAN CORP"}</span>
            </Link>
          ...
          {/* Contact */}
          <div>
            <h4 className="font-serif text-xl mb-4 font-bold">Hubungi Kami</h4>
          ...
          {/* Social */}
          <div>
            <h4 className="font-serif text-xl mb-4 font-bold">Ikuti Kami</h4>

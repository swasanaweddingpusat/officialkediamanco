        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Meet our team of certified fitness experts ready to guide your journey
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          {isLoading ? (
              ...
              {activeTrainers.map((trainer, index) => (
                ...
                >
                  <div className="relative overflow-hidden rounded-2xl aspect-[3/4] mb-4">
                    <img
                      src={trainer.photo_url || trainerImage}
                      alt={trainer.name}
                    ...
                    {trainer.instagram && (
                      <a
                        ...
                        className="absolute bottom-4 right-4 p-2 bg-background/80 backdrop-blur rounded-lg hover:bg-primary transition-colors"
                      >
            ...
            <div className="text-center py-16">
              <p className="text-muted-foreground text-lg">No trainers available yet.</p>
            </div>
          )}
        </div>
      </section>
